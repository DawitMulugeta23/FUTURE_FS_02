    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Download a copy of all your leads, notes, activities, and account
          information
        </p>
        ...
        <div className="flex space-x-3">
          ...
          <button
            type="button"
            className="px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 transition-colors flex items-center space-x-2"
          >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Data older than this will be automatically archived or deleted based
            on your settings
          </p>
        </div>
      </div>
          ...
          >
            <div className="text-center">
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => setShowDeleteConfirm(false)}
                  className="flex-1 px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 transition-colors"
                >
                  Cancel
                </button>
                <button
