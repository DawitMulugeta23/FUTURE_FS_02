...
import { FiMail, FiLock, FiLogIn, FiMic, FiVolume2, FiHelpCircle } from 'react-icons/fi';
...
const VoiceLogin = () => {
    ...
    const { voiceMode, isListening, transcript, speak, startListening, stopListening } = useVoice();
    ...
    useEffect(() => {
        if (voiceMode && transcript) {
            ...
            if (lowerTranscript.includes('password') || lowerTranscript.includes('pass')) {
            ...
            <AnimatePresence>
                {voiceMode && (
                    ...
                    >
                        ...
                        <span>Voice Mode Active - {isListening ? 'Listening...' : 'Click mic to speak'}</span>
                    </motion.div>
                )}
            </AnimatePresence>
