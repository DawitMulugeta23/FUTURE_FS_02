...
const Settings = () => {
    ...
    // Test voice
    const testVoice = () => {
        speak('This is a test of your voice settings. Hello, I am your CRM assistant. How can I help you today?');
    ...
    const resetToDefaults = () => {
        if (activeTab === 'appearance') {
            ...
            setVoiceSettingsLocal({
                ...
                autoGainControl: true,
                commandHistory: [],
                shortcuts: { next: 'next', previous: 'previous', stop: 'stop', help: 'help' }
            });
        }
                            ...
                            <div className="flex border-b dark:border-gray-700 overflow-x-auto scrollbar-hide">
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <Icon className={`h-5 w-5 ${isActive ? colors[tab.color].split(' ')[0] : ''}`} />
                                            <span>{tab.name}</span>
                                            {isActive && (
                                                <motion.div
                                                    layoutId="activeTab"
                                            ...
                                            {activeSubTab === 'general' && (
                                                <>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        {Object.entries(notifications).slice(0, 8).map(([key, value]) => (
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                            <div className="flex items-center justify-between">
                                                                <div>
                                                                    <p className="font-medium text-gray-900 dark:text-white">New Lead Created</p>
                                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Get notified when a new lead is added</p>
                                                                </div>
                                                                <label className="relative inline-flex items-center cursor-pointer">
                                                        ...
                                                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                            <div className="flex items-center justify-between">
                                                                <div>
                                                                    <p className="font-medium text-gray-900 dark:text-white">Lead Status Changed</p>
                                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Get notified when lead status changes</p>
                                                                </div>
                                                                <label className="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" className="sr-only peer" defaultChecked />
                                                                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                        ...
                                                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                            <div className="flex items-center justify-between">
                                                                <div>
                                                                    <p className="font-medium text-gray-900 dark:text-white">Lead Converted</p>
                                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Get notified when a lead converts</p>
                                                                </div>
                                                                <label className="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" className="sr-only peer" defaultChecked />
                                                                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                        ...
                                                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                            <div className="flex items-center justify-between">
                                                                <div>
                                                                    ...
                                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Get reminded to follow up with leads</p>
                                                                </div>
                                                                <label className="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" className="sr-only peer" defaultChecked />
                                                                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                            <div>
                                                                ...
                                                                <p className="text-xs text-gray-500 dark:text-gray-400">Hear spoken feedback for actions</p>
                                                            </div>
                                                            <label className="relative inline-flex items-center cursor-pointer">
                                                                <input
                                                                    type="checkbox"
                                                        ...
                                                        <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                            <div>
                                                                <p className="font-medium text-gray-900 dark:text-white">Wake Word Detection</p>
                                                                <p className="text-xs text-gray-500 dark:text-gray-400">Listen for wake word to activate voice mode</p>
                                                            </div>
                                                            <label className="relative inline-flex items-center cursor-pointer">
                                                                <input
                                                                    type="checkbox"
                                        ...
                                        <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-xl p-6 text-white">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center space-x-4">
                                                    <div className={`p-4 rounded-full ${voiceMode ? 'bg-white/20 animate-pulse' : 'bg-white/10'}`}>
                                                        {voiceMode ? (
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-white/80 text-sm mt-1">
                                                            {voiceMode 
                                                                ? isListening ? 'Listening for commands...' : 'Click the mic to start listening'
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                    <span className="text-sm text-gray-700 dark:text-gray-300">Noise Suppression</span>
                                                    <label className="relative inline-flex items-center cursor-pointer">
                                                        <input
                                                            type="checkbox"
                                                ...
                                                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                    <span className="text-sm text-gray-700 dark:text-gray-300">Continuous Listening</span>
                                                    <label className="relative inline-flex items-center cursor-pointer">
                                                        <input
                                                            type="checkbox"
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                                {[
                                                    ...
                                                    <div key={index} className="flex items-center space-x-2 p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                        ...
                                                        <span className="text-sm text-gray-700 dark:text-gray-300">"{cmd}"</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                                ...
                                                {['light', 'dark', 'system'].map((themeOption) => (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between mb-2">
                                                            {themeOption === 'light' && <FiSun className="h-5 w-5 text-yellow-500" />}
                                                            {themeOption === 'dark' && <FiMoon className="h-5 w-5 text-blue-500" />}
                                                            {themeOption === 'system' && <FiSettingsIcon className="h-5 w-5 text-gray-500" />}
                                                            {appearance.theme === themeOption && <FiCheck className="h-4 w-4 text-primary-600" />}
                                                        </div>
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500 dark:text-gray-400">Enable smooth animations throughout the app</p>
                                                    </div>
                                                    <label className="relative inline-flex items-center cursor-pointer">
                                                        <input
                                                            type="checkbox"
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <p className="font-medium text-gray-900 dark:text-white">Show Avatars</p>
                                                        <p className="text-sm text-gray-500 dark:text-gray-400">Display profile pictures throughout the app</p>
                                                    </div>
                                                    <label className="relative inline-flex items-center cursor-pointer">
                                                        <input
                                                            type="checkbox"
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        onChange={(e) => handleAppearanceChange('firstDayOfWeek', e.target.value)}
                                                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg 
                                                                 focus:outline-none focus:ring-2 focus:ring-primary-500
                                                                 dark:bg-gray-700 dark:text-white"
                                                    >
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        onChange={(e) => handleAppearanceChange('defaultView', e.target.value)}
                                                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg 
                                                                 focus:outline-none focus:ring-2 focus:ring-primary-500
                                                                 dark:bg-gray-700 dark:text-white"
                                                    >
                                ...
                                {activeTab === 'privacy' && (
                                    ...
                                    >
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="space-y-3">
                                                {['public', 'contacts', 'private'].map((visibility) => (
                                                    <label key={visibility} className="flex items-center space-x-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                                        <input
                                                            type="radio"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                                ...
                                                                {visibility === 'contacts' && 'Only your contacts can see your profile'}
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="space-y-4">
                                                {[
                                                    { key: 'showEmail', label: 'Email Address', description: 'Show your email on your profile' },
                                                    { key: 'showPhone', label: 'Phone Number', description: 'Show your phone number on your profile' },
                                                    { key: 'showCompany', label: 'Company', description: 'Show your company on your profile' },
                                                    { key: 'showPosition', label: 'Position', description: 'Show your job position on your profile' }
                                                ].map((item) => (
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="space-y-4">
                                                {[
                                                    { key: 'allowDataCollection', label: 'Usage Data', description: 'Allow anonymous usage data collection to improve the product' },
                                                    { key: 'allowAnalytics', label: 'Analytics', description: 'Allow analytics tracking' },
                                                    { key: 'allowCookies', label: 'Cookies', description: 'Allow essential cookies for functionality' }
                                                ].map((item) => (
                                                    <div key={item.key} className="flex items-center justify-between">
                                                        <div>
                                                            <p className="font-medium text-gray-900 dark:text-white">{item.label}</p>
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <p className="font-medium text-gray-900 dark:text-white">Device History</p>
                                                        <p className="text-sm text-gray-500 dark:text-gray-400">Track devices that have accessed your account</p>
                                                    </div>
                                                    <label className="relative inline-flex items-center cursor-pointer">
                                                        <input
                                                            type="checkbox"
                                                            checked={privacy.deviceHistory}
                                                            onChange={() => handlePrivacyChange('deviceHistory')}
                                                            className="sr-only peer"
                                                        />
                                                        <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                    </label>
                                                ...
                                                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-500 dark:text-gray-400">IP: 192.168.1.1 • Last active: Now</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-500 dark:text-gray-400">IP: 192.168.1.2 • Last active: 2 hours ago</p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="space-y-4 mb-6">
                                                ...
                                                <div className="space-y-2">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <label className="relative inline-flex items-center cursor-pointer">
                                                            <input
                                                                ...
                                                                onChange={(e) => setDataManagement({...dataManagement, includeNotes: e.target.checked})}
                                                                className="sr-only peer"
                                                            />
                                                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                        </label>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span className="text-sm text-gray-700 dark:text-gray-300">Include Activities</span>
                                                        <label className="relative inline-flex items-center cursor-pointer">
                                                            <input
                                                                type="checkbox"
                                                                checked={dataManagement.includeActivities}
                                                                onChange={(e) => setDataManagement({...dataManagement, includeActivities: e.target.checked})}
                                                                className="sr-only peer"
                                                            />
                                                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                        </label>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <label className="relative inline-flex items-center cursor-pointer">
                                                            <input
                                                                ...
                                                                onChange={(e) => setDataManagement({...dataManagement, includeAttachments: e.target.checked})}
                                                                className="sr-only peer"
                                                            />
                                                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                        </label>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span className="text-sm text-gray-700 dark:text-gray-300">Anonymize Data</span>
                                                        <label className="relative inline-flex items-center cursor-pointer">
                                                            <input
                                                                type="checkbox"
                                                                checked={dataManagement.anonymizeData}
                                                                onChange={(e) => setDataManagement({...dataManagement, anonymizeData: e.target.checked})}
                                                                className="sr-only peer"
                                                            />
                                                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-500 peer-checked:bg-primary-600"></div>
                                                        </label>
                                            ...
                                            <div className="flex space-x-3">
                                                ...
                                                <button
                                                    className="px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors flex items-center space-x-2"
                                                >
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                                    Data older than this will be automatically archived or deleted based on your settings
                                                </p>
                                            </div>
                                        </div>
