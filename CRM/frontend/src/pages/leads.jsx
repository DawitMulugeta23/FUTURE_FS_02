...
const Leads = () => {
  ...
  const [showFilters, setShowFilters] = useState(false); // <--- This is the variable causing the error

  const [showEmailComposer, setShowEmailComposer] = useState(false);

  const [selectedLeadsForEmail, setSelectedLeadsForEmail] = useState([]);

  // Fetch leads on mount or when filters/pagination change
